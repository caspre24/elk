 ...
 * International Symposium on Graph Drawing (GD '03)</i>, LNCS vol. 2912, pp. 381-386, Springer, 2004.</li>
 ...
 * <dl>
 * <dt>Precondition:</dt>
 * <dd>the graph has a proper layering with assigned node and port positions; the size of each layer is correctly set;
 * edges connected to ports on strange sides were processed</dd>
 * <dt>Postcondition:</dt>
 * <dd>each node is assigned a horizontal coordinate; the bend points of each edge are set; the width of the whole graph
 * is set</dd>
 * </dl>
 *
 * @author msp
...
public final class OrthogonalEdgeRouter implements ILayoutPhase {
    ...
    /*
     * The basic processing strategy for this phase is empty. Depending on the graph features, dependencies on
     * intermediate processors are added dynamically as follows:
     * 
     * Before phase 1: - None.
     * 
     * Before phase 2: - For center edge labels: - LABEL_DUMMY_INSERTER
     * 
     * Before phase 3: - For non-free ports: - NORTH_SOUTH_PORT_PREPROCESSOR - INVERTED_PORT_PROCESSOR
     * 
     * - For self-loops: - SELF_LOOP_PROCESSOR
     * 
     * - For hierarchical ports: - HIERARCHICAL_PORT_CONSTRAINT_PROCESSOR
     * 
     * - For center edge labels: - LABEL_DUMMY_SWITCHER
     * 
     * Before phase 4: - For hyperedges: - HYPEREDGE_DUMMY_MERGER
     * 
     * - For hierarchical ports: - HIERARCHICAL_PORT_DUMMY_SIZE_PROCESSOR
     * 
     * - For edge labels: - LABEL_SIDE_SELECTOR
     * 
     * Before phase 5:
     * 
     * After phase 5: - For non-free ports: - NORTH_SOUTH_PORT_POSTPROCESSOR
     * 
     * - For hierarchical ports: - HIERARCHICAL_PORT_ORTHOGONAL_EDGE_ROUTER
     * 
     * - For center edge labels: - LABEL_DUMMY_REMOVER
     * 
     * - For end edge labels: - END_LABEL_PROCESSOR
     */
