...
public class LazyBundleHandler implements IBundleHandler {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.elk.alg.layered.p5edges.bundles.IBundleHandler#mergeHypernodes(java.util.List, java.util.Map, org.eclipse.elk.alg.layered.p5edges.OrthogonalRoutingGenerator.IRoutingDirectionStrategy, int)
     */
    @Override
